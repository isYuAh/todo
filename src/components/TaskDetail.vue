...
<a-tabs position="left">
    ...
    <a-tab-pane key="3" title="提交" :disabled="!('submitItems' in focusTodo.origin)">
        <div class="submitPageContainer">
          <TodoSubmit v-if="'submitItems' in focusTodo.origin" :items="focusTodo.origin.submitItems || []" />
        </div>
    </a-tab-pane>
</a-tabs>
</template>
...
import TodoSubmit from "@/pages/TodoSubmit.vue";
//END Markdown
